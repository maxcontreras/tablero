...
//				return "<pre>" . htmlspecialchars( $this->_sql ) . "</pre>";
			...
			*/
			...
			/**
			* @return tabla con el diagnostico de la ultima consulta
			*/
			function explain() {
				$temp = $this->_sql;
